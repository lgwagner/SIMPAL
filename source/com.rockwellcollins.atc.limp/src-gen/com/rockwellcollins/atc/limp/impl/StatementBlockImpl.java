 ...
 * </p>
 * <ul>
 *   <li>{@link com.rockwellcollins.atc.limp.impl.StatementBlockImpl#getStatements <em>Statements</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StatementBlockImpl extends MinimalEObjectImpl.Container implements StatementBlock
{
  ...
  {
    return LimpPackage.Literals.STATEMENT_BLOCK;
  }
  ...
  public EList<Statement> getStatements()
  {
    if (statements == null)
    {
      statements = new EObjectContainmentEList<Statement>(Statement.class, this, LimpPackage.STATEMENT_BLOCK__STATEMENTS);
    }
    return statements;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case LimpPackage.STATEMENT_BLOCK__STATEMENTS:
